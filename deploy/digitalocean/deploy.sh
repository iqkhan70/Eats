...
JWT_ACCESS_TOKEN_EXPIRATION_MINUTES=${JWT_ACCESS_TOKEN_EXPIRATION_MINUTES:-60}
...
SERVICE_FEE_RATE=${SERVICE_FEE_RATE:-0.05}
SERVICE_FEE_MINIMUM=${SERVICE_FEE_MINIMUM:-1.5}
SERVICE_FEE_CAP=${SERVICE_FEE_CAP:-0}
"
...
SERVICE_FEE_RATE=${SERVICE_FEE_RATE:-0.03}
SERVICE_FEE_MINIMUM=${SERVICE_FEE_MINIMUM:-1.5}
SERVICE_FEE_CAP=${SERVICE_FEE_CAP:-0}
"
